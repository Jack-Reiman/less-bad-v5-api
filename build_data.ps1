...
$categories = @(
    ...
    @{
        ...
        pages = @(
            @{ title = "Motor (11W & 5.5W)"; source = "Motor.html"; dest = "api/cpp/motor.html"; className = "vex::motor"; port = "Smart Port 1-21"; summary = "V5 11W and 5.5W Smart Motors with integrated encoders, cartridge gear ratios, and live telemetry." }
    ...
    @{
        ...
        pages = @(
            ...
            @{ title = "Brain Screen"; source = "Brain/Brain.Screen.html"; dest = "api/cpp/brain_screen.html"; className = "vex::brain::lcd"; port = "V5 Touchscreen"; summary = "Full-color touchscreen graphics, shape rendering, text printing, and touch events." }
            @{ title = "Brain Battery"; source = "Brain/Brain.Battery.html"; dest = "api/cpp/brain_battery.html"; className = "vex::brain::battery"; port = "V5 Battery"; summary = "Battery telemetry including voltage, current draw, temperature, and percentage capacity." }
            @{ title = "Brain SD Card"; source = "Brain/Brain.SDcard.html"; dest = "api/cpp/brain_sdcard.html"; className = "vex::brain::sdcard"; port = "MicroSD Slot"; summary = "File system access for reading and writing files to the micro-SD card." }
            ...
            @{ title = "Controller"; source = "Controller/index.html"; dest = "api/cpp/controller.html"; className = "vex::controller"; port = "V5 Controller"; summary = "V5 handheld remote controller interface for sticks, buttons, rumble, and screen." }
            @{ title = "Controller Axis"; source = "Controller/Controller.Axis.html"; dest = "api/cpp/controller_axis.html"; className = "vex::controller::axis"; port = "Joysticks"; summary = "Analog joystick channels (Axis1, Axis2, Axis3, Axis4) with position and callbacks." }
            @{ title = "Controller Button"; source = "Controller/Controller.Button.html"; dest = "api/cpp/controller_button.html"; className = "vex::controller::button"; port = "Buttons"; summary = "Digital controller buttons (L1, L2, R1, R2, Up, Down, Left, Right, A, B, X, Y)." }
            @{ title = "Controller Screen"; source = "Controller/Controller.Screen.html"; dest = "api/cpp/controller_screen.html"; className = "vex::controller::lcd"; port = "LCD Display"; summary = "Handheld controller screen text printing, cursor positioning, and line clearing." }
        )
    },
    @{
        name = "Smart Sensors"
    ...
    @{
        ...
        pages = @(
            ...
            @{ title = "Potentiometer"; source = "Potentiometer.html"; dest = "api/cpp/potentiometer.html"; className = "vex::pot"; port = "3-Wire Port A-H"; summary = "Analog rotary potentiometer measuring up to 250 degrees of shaft position (aliased as vex::potentiometer)." }
            @{ title = "Potentiometer V2"; source = "PotentiometerV2.html"; dest = "api/cpp/potentiometer_v2.html"; className = "vex::potV2"; port = "3-Wire Port A-H"; summary = "V2 330-degree rotary potentiometer with enhanced linearity (aliased as vex::potentiometerV2)." }
            @{ title = "Range Finder (Sonar)"; source = "Sonar.html"; dest = "api/cpp/sonar.html"; className = "vex::sonar"; port = "3-Wire Ports (Pairs)"; summary = "3-Wire Ultrasonic Range Finder sensor measuring distance to objects via ultrasonic sound waves." }
